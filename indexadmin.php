    ...
    <div id="intro" class="parallax-window" data-parallax="scroll" data-image-src="img/antique-cafe-bg-01.jpg">
        <nav id="tm-nav">
            <div class="tm-container mx-auto px-2 md:py-6 text-right">
                <button  id="menu-toggle" class="absolute top-0 right-0 mt-4 mr-4"><i class="fas fa-2x fa-bars tm-text-gold"></i></button>
        ...
        <div class="container mx-auto px-2 tm-intro-width">
            <div class="sm:pb-60 sm:pt-48 py-20">
                <div class="bg-black bg-opacity-70 p-12 mb-5 text-center">
                    <h1 class="text-white text-5xl tm-logo-font mb-5">Aquatro Coffe</h1>
                    <p class="tm-text-gold tm-text-2xl">Kopi yang Rasanya,Rasanya Seperti Menjadi Iron Man</p>
                </div>    
                <div class="bg-black bg-opacity-70 p-10 mb-5">
                    <p class="text-white leading-8 text-sm font-light">
                        Aku ingin menjelma menjadi apa yang kau inginkan di dalam secangkir kopi. Tak apa aku akan menjadi pahit atau manis, asal kau tetap merindukan rasanya. <a rel="nofollow" href="https://www.instagram.com/aquatro_group?igsh=a29vaWpycGM5bHZ5" target="_parent">send us a message</a>. </p>
                </div>
                <div class="text-center">
                    <div class="inline-block">
                        <a href="#menu" class="flex justify-center items-center bg-black bg-opacity-70 py-6 px-8 rounded-lg font-semibold tm-text-2xl tm-text-gold hover:text-gray-200 transition">
                            ...
                            <span>Ayo Kita Lihat Menunya</span>                        
                        </a>
                    </div>                    
                </div>                
            </div>
    ...
    <div id="menu" class="parallax-window" data-parallax="scroll" data-image-src="img/antique-cafe-bg-02.jpg">
        <div class="container mx-auto tm-container py-24 sm:py-48">
            <div class="text-center mb-16">
                <h2 class="bg-white tm-text-brown py-6 px-12 text-4xl font-medium inline-block rounded-md">Daftar Menu Aquatro Cafe</h2>
            </div>            
                ...
                <div class="flex-1 m-5 rounded-xl px-4 py-6 sm:px-8 sm:py-10 tm-bg-brown tm-item-container">
                    <div class="flex items-start mb-6 tm-menu-item">
                        ...
                        <div class="ml-3 sm:ml-6">
                            <h3 class="text-lg sm:text-xl mb-2 sm:mb-3 tm-text-yellow"><a href="filosofi1.html">Hot Cappuccino</a></h3>
                            <div class="text-white text-md sm:text-lg font-light mb-1">S Rp.15.000</div>
                            <div class="text-white text-md sm:text-lg font-light">L Rp.20.000</div>
                        </div>                    
                    </div>
                    <div class="flex items-start mb-6 tm-menu-item">
                        <img src="img/menu-item-2.jpg" alt="Image" class="rounded-md">
                        <div class="ml-3 sm:ml-6">
                            <h3 class="text-lg sm:text-xl mb-2 sm:mb-3 tm-text-yellow"><a href="filosofi1 copy.html">Hot Americano</a></h3>
                            <div class="text-white text-md sm:text-lg font-light mb-1">S Rp.10.000</div>
                            <div class="text-white text-md sm:text-lg font-light">L Rp.15.000</div>
                        </div>                    
                    </div>
                    <div class="flex items-start mb-6 tm-menu-item">
                        <img src="img/menu-item-3.jpg" alt="Image" class="rounded-md">
                        <div class="ml-3 sm:ml-6">
                            <h3 class="text-lg sm:text-xl mb-2 sm:mb-3 tm-text-yellow"><a href="filosofi1 copy 2.html">Hot Latte </a></h3>
                    ...
                    <div class="flex items-start mb-6 tm-menu-item">
                        ...
                        <div class="ml-3 sm:ml-6">
                            <h3 class="text-lg sm:text-xl mb-2 sm:mb-3 tm-text-yellow"><a href="filosofi1 copy 3.html">Hot Chocolate</a></h3>
                            <div class="text-white text-md sm:text-lg font-light mb-1">M Rp.12.000</div>
                            <div class="text-white text-md sm:text-lg font-light">L Rp.14.000</div>
                        </div>                    
                    </div>
                    <div class="flex items-start mb-6 tm-menu-item">
                        ...
                        <div class="ml-3 sm:ml-6">
                            ...
                            <div class="text-white text-md sm:text-lg font-light mb-1">M Rp.10.000</div>
                            <div class="text-white text-md sm:text-lg font-light">L Rp.14.000</div>
                        </div>                    
                    </div>
                </div>
                <div class="flex-1 m-5 rounded-xl px-4 py-6 sm:px-8 sm:py-10 tm-bg-brown tm-item-container">
                    <div class="flex items-start justify-end mb-6 tm-menu-item-2">
                        <div class="text-right mr-6">
                            ...
                            <div class="text-white text-md sm:text-lg font-light mb-1">Small Rp.18.000</div>
                            <div class="text-white text-md sm:text-lg font-light">Large Rp.20.000</div>
                        </div>
                    ...
                    <div class="flex items-start justify-end mb-6 tm-menu-item-2">
                        <div class="text-right mr-6">
                            ...
                            <div class="text-white text-md sm:text-lg font-light mb-1">Small Rp.13.000</div>
                            <div class="text-white text-md sm:text-lg font-light">Large Rp.15.000</div>
                        </div>
                    ...
                    <div class="flex items-start justify-end mb-6 tm-menu-item-2">
                        <div class="text-right mr-6">
                            ...
                            <div class="text-white text-md sm:text-lg font-light mb-1">Small Rp.16.000</div>
                            <div class="text-white text-md sm:text-lg font-light">Large Rp.18.000</div>
                        </div>   
                    ...
                    <div class="flex items-start justify-end mb-6 tm-menu-item-2">                    
                        <div class="text-right mr-6">
                            ...
                            <div class="text-white text-md sm:text-lg font-light mb-1">Small Rp.17.000</div>
                            <div class="text-white text-md sm:text-lg font-light">Large Rp.21.000</div>
                        </div> 
                        <img src="img/menu-item-8.jpg" alt="Image" class="rounded-md">                   
                    </div>
                    <div class="flex items-start justify-end mb-6 tm-menu-item-2">                    
                        <div class="text-right mr-6">
                            <h3 class="text-lg sm:text-xl mb-2 sm:mb-3 tm-text-yellow">Es Teh</h3>
                            <div class="text-white text-md sm:text-lg font-light mb-1">Small Rp.5.000</div>
                            <div class="text-white text-md sm:text-lg font-light">Large Rp.7.000</div>
                        </div> 
                        <img src="img/menu-item-8.jpg" alt="Image" class="rounded-md">                   
                    </div>
                     
                </div><div class="text-center mb-16">
                        <h2 class="bg-white tm-text-brown py-6 px-12 text-4xl font-medium inline-block rounded-md"><a href="Pesan.php">Pesan</a></h2>
                    </div>    
            </div>
        </div>        
    </div>
        ...
        <div class="container mx-auto tm-container pt-24 pb-48 sm:py-48">
            <div class="flex flex-col lg:flex-row justify-around items-center lg:items-stretch">
                <div class="flex-1 rounded-xl px-10 py-12 m-5 bg-white bg-opacity-80 tm-item-container">
                    ...
                    <p class="mb-10 text-lg">
                        <span class="block mb-2">Tel: <a href="https://chat.whatsapp.com/J4wj14c0eft8jRJH00QRZ4" class="hover:text-yellow-600 transition">0852-4409-6950</a></span>
                        <span class="block">Ig: <a href="https://www.instagram.com/aquatro_group?igsh=MWxoY3hkb3FycXRvYQ==" class="hover:text-yellow-600 transition">Aquatro_group</a></span>                        
                    </p>
                    <div class="text-center">
                        <a href="https://maps.app.goo.gl/fM6zTxQWSN4fofCQ9" class="inline-block text-white text-2xl pl-10 pr-12 py-6 rounded-lg transition tm-bg-green">
            ...
            <footer class="absolute bottom-0 left-0 w-full">
                <div class="text-white container mx-auto tm-container p-8 text-lg flex flex-col md:flex-row justify-between">
                    <span class="mt-5 md:mt-0">Design: <a href="https://www.instagram.com/aquatro_group?igsh=a29vaWpycGM5bHZ5" target="_parent">Aquatro</a></span>
                </div>                
            </footer>
        </div>        
    </div>    
